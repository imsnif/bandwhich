...
fn pause_by_space() {
    ...
    events.push(Some(Event::Key(KeyEvent{modifiers: KeyModifiers::NONE, code: KeyCode::Char(' ')})));
    events.push(None);
    events.push(None);
    events.push(Some(Event::Key(KeyEvent{modifiers: KeyModifiers::NONE, code: KeyCode::Char(' ')})));
...
fn rearranged_by_tab() {
    ...
    let mut events: Vec<Option<Event>> = iter::repeat(None).take(1).collect();
    events.push(None);
    events.push(Some(Event::Key(KeyEvent{modifiers: KeyModifiers::NONE, code: KeyCode::Tab})));
    events.push(None);
    events.push(None);
    events.push(Some(Event::Key(KeyEvent{modifiers: KeyModifiers::CONTROL, code: KeyCode::Char('c')})));
